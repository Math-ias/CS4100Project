...
# Random incomplete, x turn
RANDOM_INCOMPLETE_MORE_LESSER = reshape(np.array([
    [
        [_, _, _],
        [_, _, _],
        [_, _, O],
...
RANDOM_INCOMPLETE_LESSERV2 = reshape(np.array([
    [
        [_, _, _],
        [X, _, _],
        [_, _, O],
...
# Random incomplete, x turn
RANDOM_INCOMPLETE_LESSER = reshape(np.array([
    [
        [_, _, _],
        [X, _, _],
        [_, _, O],
...
# Random incomplete, x turn
RANDOM_INCOMPLETE_LESS = reshape(np.array([
    [
        [_, _, _],
        [X, _, _],
        [_, _, O],
...
# Random incomplete, x turn
RANDOM_INCOMPLETE = reshape(np.array([
    [
        [_, _, _],
        [X, _, _],
        [_, O, O],
...
# Eleven from, X turn
ELEVEN_FROM_FILLED = reshape(np.array([
    [
        [X, O, X],
        [O, X, O],
        [O, _, O],
...
# Ten from, O Turn
TEN_FROM_FILLED = reshape(np.array([
    [
        [X, O, X],
        [O, X, O],
        [O, X, O],
...
# Nine Moves, X Turn
NINE_FROM_FILLED = reshape(np.array([
    [
        [X, O, X],
        [O, X, O],
        [O, X, O],
...
FIVE_FROM_FILLED = reshape(np.array([
    [
        [X, O, X],
        [O, X, O],
        [O, X, O],
